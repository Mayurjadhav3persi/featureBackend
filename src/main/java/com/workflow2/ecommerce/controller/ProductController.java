...
public class ProductController {
     ...
     * @param subCategory It contains the category name whose products we wanted to find
     * @return It returns the list of all the products belong to given category
     */
    @GetMapping("/subCategory/{subCategory}")
    public ResponseEntity<List<ProductDTO>> getAllProductBySubCategory(@PathVariable("subCategory") String subCategory){
        System.out.println("in subcategory: " +subCategory);
        return productService.getAllProductBySubCategory(subCategory);
    }
